...
public class ItemHelper {
    ...
    public int getTilePrice(int tileCustomSpriteId) {
        return -1;
    }
    ...
    public enum objects {
        HOUSE_ONE, HOUSE_TWO, HOUSE_SIX, HOUSE_NINE, PILLAR_YELLOW, STATUE_ANGRY_YELLOW, MONK_STATUE_BALL_YELLOW, MONK_STATUE_YELLOW, SOLDIER_SPEAR_YELLOW, PLANTER_STICKS_YELLOW, CUBE_YELLOW, FROG_YELLOW, SOLDIER_SWORD_YELLOW, PILLAR_SHORT_YELLOW, PILLAR_SNOW_YELLOW, PILLAR_GREEN, STATUE_ANGRY_GREEN, MONK_STATUE_BALL_GREEN, MONK_STATUE_GREEN, SOLDIER_SPEAR_GREEN, PLANTER_STICKS_GREEN, CUBE_GREEN, FROG_GREEN, SOLDIER_SWORD_GREEN, PILLAR_SHORT_GREEN, PILLAR_SNOW_GREEN, POT_ONE_FULL, POT_ONE_EMPTY, POT_TWO_FULL, POT_TWO_EMPTY, BASKET_FULL_RED_FRUIT, BASKET_FULL_CHICKEN, BASKET_EMPTY, BASKET_FULL_BREAD, OVEN_SNOW_YELLOW, OVEN_YELLOW, OVEN_GREEN, STOMP, SMALL_POT_FULL, SMALL_POT_EMPTY, PLANT, DRAWERS, BOOK_SHELF_SMALL, BOOK_SHELF_SMALL_EMPTY, DRAWERS_BIG, BOOK_SHELF, BOOK_SHELF_EMPTY, CHAIR, BLUE_POT, PAINTING, BASEMENT_OAK, BASEMENT_BIRCH, BASEMENT_ACACIA, BASEMENT_PRISMARIN, POT_EMPTY, TABLE, TABLE2, TABLE3, WELL, PIGENS, CABINET, OVEN, REFRIGERATOR, SOFA_RIGHT, SOFA_DOWN, SMALL_SOFA_DOWN, SMALL_SOFA_UP, OAK_BOOKSHELF, BIRCH_BOOKSHELF, CHAIR_BIRCH_DOWN, CHAIR_BIRCH_RIGHT, CHAIR_OAK_DOWN, TABLE_BIG, CARPET, DRAWERS_OAK, TOOLSET_HANGING, CLOCK, PLANT2, STOOL, STOOL_HIGH, DESK, CABINET_P1, CABINET_P2;

...
public class MapHelper {
    ...
    private static List<GameObject> createRoomBig2() {
        ...
        list.add(new GameObject(new PointF(HOUSE_X_START, HOUSE_Y_START - (float) GameObjects.REFRIGERATOR.getHeight() / 4), GameObjects.REFRIGERATOR));
    ...
    private static List<GameObject> createRoomBig3() {
        //TODO: decorate another cool room
        var list = new ArrayList<GameObject>();
        list.add(new GameObject(new PointF(HOUSE_X_START + GameObjects.PLANT2.getWidth() + 10, HOUSE_BIG_HEIGHT_POS - 30), GameObjects.SMALL_SOFA_UP));
        list.add(new GameObject(new PointF(HOUSE_X_START, HOUSE_BIG_HEIGHT_POS - GameObjects.PLANT2.getHeight() - GameObjects.SOFA_RIGHT.getHitboxHeight()), GameObjects.SOFA_RIGHT));
        list.add(new GameObject(new PointF(HOUSE_X_START, HOUSE_BIG_HEIGHT_POS - 75), GameObjects.PLANT2));

        list.add(new GameObject(new PointF(HOUSE_X_START, HOUSE_Y_START + (float) GameObjects.OAK_BOOKSHELF.getHeight() / 3 * 2), GameObjects.OAK_BOOKSHELF));
        list.add(new GameObject(new PointF(HOUSE_X_START + GameObjects.OAK_BOOKSHELF.getWidth(), HOUSE_Y_START + (float) GameObjects.CLOCK.getHeight() / 3 * 2), GameObjects.CLOCK));
        return list;
    }

    private static List<GameObject> createRoomMail() {
        //TODO: make a mail room.
        var list = new ArrayList<GameObject>();
        list.add(new GameObject(new PointF(HOUSE_X_START, HOUSE_Y_START - (float) GameObjects.REFRIGERATOR.getHeight() / 4), GameObjects.REFRIGERATOR));
        list.add(new GameObject(new PointF(HOUSE_X_START + GameObjects.REFRIGERATOR.getWidth(), HOUSE_Y_START - (float) GameObjects.CABINET.getHeight() / 4), GameObjects.CABINET));
        list.add(new GameObject(new PointF(HOUSE_X_START + GameObjects.REFRIGERATOR.getWidth() + GameObjects.CABINET.getWidth(), HOUSE_Y_START - (float) GameObjects.OVEN.getHeight() / 4), GameObjects.OVEN));

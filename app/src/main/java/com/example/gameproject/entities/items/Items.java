...
public enum Items implements BitmapMethods {
    ...
    BAKEWELLTART(R.drawable.bakewelltart),
    ...
    GIANTGUMMYBEAR(R.drawable.giantgummybear),
    GINGERBREADMAN_DISH(R.drawable.gingerbreadman_dish),
    GLAZEDCINNAMONROLL(R.drawable.glazedcinnamonroll),
    ...
    GREENJELLY(R.drawable.greenjelly),
    ...
    LEMONBLUEBERRYPOT(R.drawable.lemonblueberrypot),
    LEMONCAKE(R.drawable.lemoncake),
    LEMONDONUT(R.drawable.lemondonut),
    LEMONPIE(R.drawable.lemonpie),
    LOAFBREAD(R.drawable.loafbread),
    LOLLIPOP(R.drawable.lollipop),
    MACNCHEESE(R.drawable.macncheese),
    ...
    MINTCHOCOLATEPOT(R.drawable.mintchocolatepot),
    MUSTARD(R.drawable.mustard),
    OLIVE_OIL(R.drawable.olive_oil),
    OMLET(R.drawable.omlet),
    OMLET_DISH(R.drawable.omlet_dish),
    ...
    PANCAKES_COOKIESN_CREAM(R.drawable.pancakes_cookiesn_cream),
    ...
    PURPLEJELLY(R.drawable.purplejelly),
    RAINBOWCAKE(R.drawable.rainbowcake),
    RAMEN(R.drawable.ramen),
    RASPBERRYCHEESECAKEPOT(R.drawable.raspberrycheesecakepot),
    REDJELLY(R.drawable.redjelly),
    REDVELVETCAKE(R.drawable.redvelvetcake),
    RED_APPLE(R.drawable.red_apple),
    ROASTEDCHICKEN_DISH(R.drawable.roastedchicken_dish),
    ...
    STRAWBERRYCAKE(R.drawable.strawberrycake),
    STRAWBERRYCAKE_DISH(R.drawable.strawberrycake_dish),
    STRAWBERRYDONUT(R.drawable.strawberrydonut),
    STRAWBERRYSHORTCAKE(R.drawable.strawberryshortcake),
    STRAWBERRYWAFFLES(R.drawable.strawberrywaffles),
    ...
    TIRIMASU(R.drawable.tirimasu),
    TUNA_CAN(R.drawable.tuna_can),
    VANILLACAKE(R.drawable.vanillacake),
    ...
    YELLOWJELLY(R.drawable.yellowjelly),
